...
void cGlobal_effect :: Update( void )
{
	...
	Set_Pos( m_start_pos_x + pActive_Camera->x, m_start_pos_y + pActive_Camera->y );
	// update particles
	Update_Particles();
...
void cGlobal_effect :: Set_Image( const std::string &nimg_file )
{
	m_image_filename = nimg_file;
}
